...
export default async function DashboardPage() {
  ...
  return <div className="space-y-7">
    ...
    <div className="grid gap-6 xl:grid-cols-2"><Card><div className="flex items-start justify-between gap-3"><h2 className="font-semibold">Gastos por categoria</h2><a href="/relatorios" className="shrink-0 text-sm font-semibold text-[var(--primary)]">Ver por período →</a></div><p className="muted mt-1 text-xs">Todas as categorias do mês · despesas antes de estornos.</p><CategoryChart data={data.categoryData} /></Card><Card><h2 className="font-semibold">Saldo por instituição</h2><InstitutionChart data={data.institutionData} /></Card></div>
